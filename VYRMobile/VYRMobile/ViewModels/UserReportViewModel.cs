...
{
    public class UserReportViewModel : BindableObject
    {
        ...
        private static UserReportViewModel _instance;
        public static UserReportViewModel Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UserReportViewModel();
        ...
        public UserReportViewModel(string Img)
        {
